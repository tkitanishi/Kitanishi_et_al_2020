...
% rec only
io('tk0056-171014-04',[0 1200]+20);
io('tk0056-171015-04',[0 1200]+15);

io('tk0062-171129-04',[0 1200]+10);
io('tk0062-171130-04',[0 1200]+30);

% with optoid
io('tk0064-180206-04',[0 1200]+15);
io('tk0064-180207-04',[0 1200]+15);

io('tk0067-180426-04',[0 1200]+10);
io('tk0067-180427-04',[0 1200]+20);

io('tk0068-180530-04',[0 1200]+20);
io('tk0068-180531-04',[0 1200]+15);

io('tk0069-180726-04',[0 1200]+10);
io('tk0069-180727-04',[0 1200]+40);

io('tk0070-180829-04',[0 1200]+12);
io('tk0070-180830-04',[0 1200]+10);

io('tk0072-181025-04',[0 1200]+10);
io('tk0072-181026-04',[0 1200]+12);

io('tk0074-181219-04',[0 1200]+10);
io('tk0074-181220-04',[0 1200]+20);

io('tk0075-190326-04',[0 1200]+10);
io('tk0075-190327-04',[0 1200]+15);

io('tk0076-190424-04',[0 1200]+10);
io('tk0076-190425-04',[0 1200]+15);
...
p.savepath = 'D:\data\rec\04L\space\';
...
imname1 = fullfile(p.savepath,sprintf('%s%s%u',session,'_u',unit));
% imname1 = fullfile(p.savepath,sprintf('%s%s%s%u%s%s','rmap_',session,'_u',unit,'_',roiName));
% imname2 = fullfile(p.savepath,sprintf('%s%s%s%u%s%s','thet_',session,'_u',unit,'_',roiName));
...
%     print('-depsc', '-tiff',epsImage);
    ...
    title(sprintf('%s%3.1f%s%3.1f%s%u%s','Mean=',meanRate,'Hz, Peak=',peakRate,'Hz (scale0-',ceil(max(map(:))),'Hz)'))
    box off
    ylabel('Distance (cm)')
    set(gca,'TickDir','out')
...
%     http://jp.mathworks.com/help/optim/examples/nonlinear-data-fitting.html
    ...
    set(gcf,'OuterPosition',[60 910 576*2 513])
...
fprintf(fid2,'%s\t', proxdist);
fprintf(fid2,'%s\t', supdeep);
fprintf(fid2,'%u\t', sh);
fprintf(fid2,'%u\t', ch);
